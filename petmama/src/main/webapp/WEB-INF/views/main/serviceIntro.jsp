...
<div class="container-fluid" style="padding:200px 20px;">
  <div class="row">
    ...
    <div class="col text-right">
	  ...
	  <p>언제 어디서든 원하시는 방법으로 ‘펫마마’ 방문 펫시터 서비스를 예약할 수 있어요</p>
    </div>
 </div>
</div>
...
<div class="container-fluid" style="padding:200px 20px;">
  <div class="row">
    ...
    <div class="col text-right">
      <p>펫마마의 모든 펫시터는 신분증 사본, 등초본, 신원보증 부대까지 3단계로</p>
...
<div class="container-fluid" style="padding:200px 20px;">
  <div class="row">
    ...
    <div class="col text-right">
      <p>펫마마의 모든 도그워커는 펫피플 교육 아카데미의 산책 전문 교육을 수료하였으며,</p>
...
<div class="container-fluid bg-secondary bg-opacity-75 text-white" style="padding:200px 20px;">
  <div class="row">
    ...
    <div class="col col-lg-5">
      <img src="${pageContext.request.contextPath}/images/자유게시판.png" style="width:900px; height:500px;">
    </div>
 </div>
</div>
