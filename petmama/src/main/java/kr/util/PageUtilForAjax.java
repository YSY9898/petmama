...
public class PageUtilForAjax {
	 ...
	 * */
	public PageUtilForAjax(int currentPage,int count, int rowCount) {
	...
	public PageUtilForAjax(String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {
...
//					page.append("<a href="+pageUrl+"?pageNum="+ (startPage - 1) + sub_url +">");
					page.append("<a href='#' onclick='getPage(" + (startPage - 1) + ")'>");
					page.append("[이전]");
					page.append("</a>");
				}
...
//						page.append("&nbsp;<a href='"+pageUrl+"?pageNum=");
						page.append("<a href='#' onclick='getPage(" + i + ")'>" + i + "</a>");
...
//					page.append("<a href="+pageUrl+"?pageNum="+ (endPage + 1) + sub_url +">");
					page.append("<a href='#' onclick='getPage(" + (endPage + 1) + ")'>");
					page.append("[다음]");
					page.append("</a>");
				}
			}else {
